...
def introduce_myself():
    ...
    <div style="font-family: sans-serif; text-align: center; margin-top: 50px;">
        <h1>Hi, welcome to my custom page!</h1>
        <p>I am a B.Tech engineering student currently diving into Python, IoT.</p>
        <p>When I'm not coding, you'll probably find me sleeping.</p>
        <br>
        <!-- The kickk -->
        <a href="https://images.unsplash.com/photo-1498050108023-c5249f4df085">
            <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085" width="500" alt="Minimalist Coding Workspace" style="border-radius: 10px; box-shadow: 0px 4px 10px rgba(0,0,0,0.2);">
        </a>
    </div>
    """